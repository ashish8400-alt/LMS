...
const Player = () => {
  ...
  const { enrolledCourses, calculteChapterTime } = useContext(AppContext)
  ...
  return (
    <>
      <div className='mt-20 p-4 sm:p-10 flex flex-col-reverse md:grid md:grid-cols-2 gap-10 md:px-36'>
